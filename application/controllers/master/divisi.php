...
class Divisi extends CI_Controller
{
    ...
    public function show_addForm()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $datapost = get_post_data(array('id_jenis_item', 'divisi'));
    ...
    public function show_editForm($id = '')
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $data['jenis_item'] = $this->db->get('master_jenis_item');
            $data['edit'] = $this->db->get_where('master_divisi_stock', array('id' => $id));
            $this->load->view('master/divisi/v_divisi_edit', $data);
        } else {
            $datapost = get_post_data(array('id', 'kode', 'divisi'));
