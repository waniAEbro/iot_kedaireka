...
class aluminium extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('inout_h/m_aluminium');
    }
    ...
    public function index()
    {
        ...
        $this->load->view('inout_h/aluminium/v_aluminium_list', $data);
    }
    ...
    public function diSetCetak($tgl_awal = '', $tgl_akhir = '')
    {
        ...
        $data['tgl_akhir']        = $tgl_akhir;
        $data['aluminium']    = $this->m_aluminium->getData($data['tgl_awal'], $data['tgl_akhir']);
        $this->load->view('inout_h/aluminium/v_aluminium_list_cetak', $data);
    }
    ...
    public function out()
    {
        ...
        $this->load->view('inout_h/aluminium/v_aluminium_list_out', $data);
    }
    ...
    public function diSetCetakOut($tgl_awal = '', $tgl_akhir = '')
    {
        ...
        $data['tgl_akhir']        = $tgl_akhir;
        $data['aluminium']    = $this->m_aluminium->getDataOut($data['tgl_awal'], $data['tgl_akhir']);
        $this->load->view('inout_h/aluminium/v_aluminium_list_cetak_out', $data);
    }
}

/* End of file aluminium.php */
/* Location: ./application/controllers/inout_h/aluminium.php */