...
class Aluminium extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('wrh_h/m_aluminium');
    ...
    public function index_lama()
    {
        ...
        $this->load->view('wrh_h/aluminium/v_aluminium_list_lama', $data);
    }
    ...
    {
        $data['judul']               = 'Monitoring Aluminium Warna HRB';
    ...
    {
        $data['judul']               = 'Monitoring Aluminium MF HRB';
        $this->load->view('wrh_h/aluminium/v_aluminium_list_mf', $data);
    }
    ...
    public function stok_in()
    {
        ...
        $this->load->view('wrh_h/aluminium/v_aluminium_in_list', $data);
    }
    ...
    public function stok_in_add()
    {
        ...
        if ($cek_in_temp < 1) {
            $this->load->view('wrh_h/aluminium/v_aluminium_in', $data);
        } else {
            $data['row_temp'] = $this->m_aksesoris->getInTemp(1)->row();
            $this->load->view('wrh_h/aluminium/v_aluminium_in_temp', $data);
        }
    }
    ...
    public function stok_out()
    {
        ...
        $this->load->view('wrh_h/aluminium/v_aluminium_out_list', $data);
    }
    ...
    public function stok_out_make($id_fppp)
    {
        ...
        $this->load->view('wrh_h/aluminium/v_aluminium_detail_bom', $data);
    }
    ...
    public function stok_out_make_mf($id_fppp)
    {
        ...
        $this->load->view('wrh_h/aluminium/v_aluminium_detail_bom_mf', $data);
    }
    ...
    public function kirim_parsial($id_fppp, $id_stock)
    {
        ...
        $this->fungsi->run_js('load_silent("wrh_h/aluminium/stok_out_make/' . $id_fppp . '","#content")');
    }
    ...
    public function kirim_parsial_mf($id_fppp, $id_stock)
    {
        ...
        $this->fungsi->message_box("Kirim Parsial berhasil", "success");
        $this->fungsi->catat($object, "Membuat kirim parsial data sbb:", true);
        $this->fungsi->run_js('load_silent("wrh_h/aluminium/stok_out_make_mf/' . $id_fppp . '","#content")');
    }
    ...
    public function buat_surat_jalan($id_fppp)
    {
        ...
        $data['no_surat_jalan'] = str_pad($this->m_aluminium->getNoSuratJalan(), 3, '0', STR_PAD_LEFT) . '/SJ/SJHRB/' . $kode_divisi . '/' . date('m') . '/' . date('Y');

        $this->load->view('wrh_h/aluminium/v_aluminium_buat_surat_jalan', $data);
    }
    ...
    public function buat_surat_jalan_mf($id_fppp)
    {
        ...
        $data['row_fppp']       = $this->m_aluminium->getRowFppp($id_fppp);
        $kode_divisi      = $this->m_aluminium->getKodeDivisi($id_fppp);
        $data['no_surat_jalan'] = str_pad($this->m_aluminium->getNoSuratJalan(), 3, '0', STR_PAD_LEFT) . '/SJMF/SJHRB/' . $kode_divisi . '/' . date('m') . '/' . date('Y');
    ...
    public function simpanSuratJalan()
    {
        ...
        $kode_divisi       = $this->m_aluminium->getKodeDivisi($id_fppp);
        $no_surat_jalan    = str_pad($this->m_aluminium->getNoSuratJalan(), 3, '0', STR_PAD_LEFT) . '/SJ/SJHRB/' . $kode_divisi . '/' . date('m') . '/' . date('Y');
        $obj               = array(
            'id_fppp'           => $id_fppp,
    ...
    public function simpanSuratJalanMf()
    {
        ...
        $no_kendaraan      = $this->input->post('no_kendaraan');
        $kode_divisi       = $this->m_aluminium->getKodeDivisi($id_fppp);
        $no_surat_jalan    = str_pad($this->m_aluminium->getNoSuratJalan(), 3, '0', STR_PAD_LEFT) . '/SJMF/SJHRB/' . $kode_divisi . '/' . date('m') . '/' . date('Y');
        $obj               = array(
            'id_fppp'           => $id_fppp,
            'no_surat_jalan'    => $no_surat_jalan,
            'penerima'          => $penerima,
    ...
    public function additemdetailbom($id_fppp)
    {
        ...
        $this->fungsi->run_js('load_silent("wrh_h/aluminium/showformitemdetailbom/' . $id_fppp . '","#divsubcontent")');
    }
    ...
    public function showformitemdetailbom($id_fppp = '')
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('wrh_h/aluminium/v_aluminium_add_item_bom', $data);
        } else {
            $datapost_bom = array(
                'is_bom'        => 1,
            ...
            $this->fungsi->run_js('load_silent("wrh_h/aluminium/stok_out_make/' . $this->input->post('id_fppp') . '","#content")');
    ...
    public function cetakSj($id)
    {
        ...
        $this->load->view('wrh_h/aluminium/v_aluminium_cetak_sj', $data);
    }
    ...
    public function cetakSjBon($id)
    {
        ...
        $this->load->view('wrh_h/aluminium/v_aluminium_cetak_sj_bon', $data);
    }
    ...
    public function bon_manual()
    {
        ...
        $data['keterangan']  = $this->m_aluminium->getKeterangan();
        $this->load->view('wrh_h/aluminium/v_aluminium_bon_list', $data);
    }
    ...
    public function bon_manual_diSet_cetak($tgl_awal = '', $tgl_akhir = '')
    {
        ...
        $data['surat_jalan'] = $this->m_aluminium->getSuratJalan(2, $id_jenis_item, $data['tgl_awal'], $data['tgl_akhir']);
        $data['keterangan']  = $this->m_aluminium->getKeterangan();
        $this->load->view('wrh_h/aluminium/v_aluminium_bon_list_cetak', $data);
    }
    ...
    public function bon_manual_add()
    {
        ...
        $this->load->view('wrh_h/aluminium/v_aluminium_bon_item', $data);
    }
    ...
    public function buat_surat_jalan_bon()
    {
        ...
        $data['id_fppp']        = $id_fppp;
        $kode_divisi      = $this->m_aluminium->getKodeDivisi($id_fppp);
        $no_surat_jalan   = str_pad($this->m_aluminium->getNoSuratJalan(), 3, '0', STR_PAD_LEFT) . '/SJBON/SJHRB/' . $kode_divisi . '/' . date('m') . '/' . date('Y');
        ...
        $data['list_sj']        = $this->m_aluminium->getListItemBonManual();
        $this->load->view('wrh_h/aluminium/v_aluminium_bon_add', $data);
    }
    ...
    public function lihat_item_stok_out($param = '')
    {
        ...
        $this->fungsi->run_js('load_silent("wrh_h/aluminium/lihat_item_stok_out_modal/' . $param . '","#divsubcontent")');
    }
    ...
    public function lihat_item_stok_out_modal($id_sj)
    {
        ...
        $this->load->view('wrh_h/aluminium/v_aluminium_lihat_item_out', $data);
    }
    ...
    public function edit_item_stok_out($id_sj)
    {
        ...
        $data['list_sj']           = $this->m_aluminium->getListItemStokOut($id_sj);
        $this->load->view('wrh_h/aluminium/v_aluminium_edit_item_out', $data);
    }
    ...
    public function mutasi_stock_add($id = '')
    {
        ...
        $this->load->view('wrh_h/aluminium/v_aluminium_mutasi_stock_add', $data);
    }
    ...
    public function mutasi_stock_history($id)
    {
        ...
        $buttons[]          = button('', 'Tutup', 'btn btn-default', 'data-dismiss="modal"');
        echo $this->fungsi->parse_modal($header, $subheader, $content, $buttons, '');
        $this->fungsi->run_js('load_silent("wrh_h/aluminium/mutasi_stock_history_show/' . $id . '","#divsubcontent")');
    }
    ...
    public function mutasi_stock_history_show($id = '')
    {
        ...
        $this->load->view('wrh_h/aluminium/v_aluminium_mutasi_stock_history', $data);
    }
    ...
    public function stockPointListCetak($tgl = '')
    {
        ...
        $this->load->view('wrh_h/aluminium/v_aluminium_stock_point_cetak', $data);
    }
    ...
    public function stok_in_wo()
    {
        ...
        $this->load->view('wrh_h/aluminium/v_aluminium_in_wo_list', $data);
    }
    ...
    public function stok_in_wo_add()
    {
        ...
        $this->db->where_in('id', ['2', '4', '58', '59', '79']);
        $data['gudang']   = $this->db->get('master_gudang');
        // $data['gudang']   = $this->db->get_where('master_gudang', array('id_jenis_item' => 1));
        $data['supplier'] = $this->db->get('master_supplier');

        $this->load->view('wrh_h/aluminium/v_aluminium_in_wo', $data);
    }
    ...
    public function deleteIn_wo($id)
    {
        ...
        $this->fungsi->run_js('load_silent("wrh_h/aluminium/stok_in_wo","#content")');
...
/* Location: ./application/controllers/wrh_h/aluminium.php */