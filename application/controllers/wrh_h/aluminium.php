...
class Aluminium extends CI_Controller
{
    ...
    public function buat_surat_jalan($id_fppp)
    {
        ...
        $data['no_surat_jalan'] = str_pad($this->m_aluminium->getNoSuratJalan(), 3, '0', STR_PAD_LEFT) . '/SJ/HRB/' . $kode_divisi . '/' . date('m') . '/' . date('Y');
    ...
    public function buat_surat_jalan_mf($id_fppp)
    {
        ...
        $data['row_fppp']       = $this->m_aluminium->getRowFppp($id_fppp);
        $kode_divisi      = $this->m_aluminium->getKodeDivisi($id_fppp);
        $data['no_surat_jalan'] = str_pad($this->m_aluminium->getNoSuratJalan(), 3, '0', STR_PAD_LEFT) . '/SJMF/HRB/' . $kode_divisi . '/' . date('m') . '/' . date('Y');
    ...
    public function simpanSuratJalan()
    {
        ...
        $kode_divisi       = $this->m_aluminium->getKodeDivisi($id_fppp);
        $no_surat_jalan    = str_pad($this->m_aluminium->getNoSuratJalan(), 3, '0', STR_PAD_LEFT) . '/SJ/HRB/' . $kode_divisi . '/' . date('m') . '/' . date('Y');
        $obj               = array(
            'id_fppp'           => $id_fppp,
    ...
    public function simpanSuratJalanMf()
    {
        ...
        $no_kendaraan      = $this->input->post('no_kendaraan');
        $kode_divisi       = $this->m_aluminium->getKodeDivisi($id_fppp);
        $no_surat_jalan    = str_pad($this->m_aluminium->getNoSuratJalan(), 3, '0', STR_PAD_LEFT) . '/SJMF/HRB/' . $kode_divisi . '/' . date('m') . '/' . date('Y');
        $obj               = array(
            'id_fppp'           => $id_fppp,
            'no_surat_jalan'    => $no_surat_jalan,
            'penerima'          => $penerima,
    ...
    public function buat_surat_jalan_bon()
    {
        ...
        $data['id_fppp']        = $id_fppp;
        $kode_divisi      = $this->m_aluminium->getKodeDivisi($id_fppp);
        $no_surat_jalan   = str_pad($this->m_aluminium->getNoSuratJalan(), 3, '0', STR_PAD_LEFT) . '/SJBON/HRB/' . $kode_divisi . '/' . date('m') . '/' . date('Y');
