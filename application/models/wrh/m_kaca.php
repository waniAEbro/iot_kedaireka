...
class M_kaca extends CI_Model
{
    ...
    public function getCetakMonitoring($id_jenis_barang)
    {
        ...
        $this->db->select('dc.*,md.divisi,mg.gudang,mi.item_code,mi.deskripsi,mi.supplier,mi.lead_time,mi.satuan,mi.area,mi.lebar,mi.tinggi');
    ...
    public function getQtyMasuk($tgl)
    {
    ...
    public function getQtyKeluar($tgl)
    {
...
/* Location: ./application/models/klg/m_kaca.php */