...
class M_aluminium extends CI_Model
{
    ...
    public function getdata()
    {
        ...
        $this->db->where_in('dc.id_gudang', ['2','4','56']);
    ...
    public function getStockAwalBulan()
    {
        ...
        $this->db->where_in('ds.id_gudang', ['2','4','56']);
        $res = $this->db->get('data_stock ds');
        $data = array();
    ...
    public function getTotalInPerBulan()
    {
        ...
        $this->db->where_in('id_gudang', ['2','4','56']);
    ...
    public function getDataStock($tgl_awal, $tgl_akhir)
    {
        ...
        $this->db->where('mi.id_jenis_item', $id_jenis_item);
        $this->db->where_in('da.id_gudang', ['2','4','56']);
    ...
    // public function mgetDivisiItem($item)
    // {
    //     $this->db->where('id', $item);
    //     return $this->db->get('master_item')->row()->id_divisi;
    // }
