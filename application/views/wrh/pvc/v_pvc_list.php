        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    ...
                    <?= button('load_silent("wrh/pvc/index_lama","#content")', 'Monitoring Lama', 'btn btn-danger', 'data-toggle="tooltip" title="Monitoring"'); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var table = $('#memListTable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo base_url('wrh/pvc/getLists/'); ?>",
                "type": "POST"
            },
        ...
        $('#memListTable tbody').on('click', 'button.mutasi', function() {
            ...
            load_silent("wrh/pvc/mutasi_stock_add/" + data[0] + "", "#content");
        });
        $('#memListTable tbody').on('click', 'button.history_mutasi', function() {
            var data = table.row($(this).parents('tr')).data();
            load_silent("wrh/pvc/mutasi_stock_history/" + data[0] + "", "#modal");
        });
