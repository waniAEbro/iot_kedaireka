                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($bln == $now) { ?>
                                        ...
                                        <?= button('load_silent("wrh/kaca/stok_in_edit/' . $row->id . '","#content")', 'Edit', 'btn btn-xs btn-primary', 'data-toggle="tooltip" title="Edit"'); ?>
...
<script type="text/javascript">
    ...
    function setAplikator(argument) {
        ...
        load_silent("wrh/kaca/stok_in_set/" + tlg1 + "/" + tgl2, "#content");
