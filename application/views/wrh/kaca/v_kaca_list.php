    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Monitoring kaca</h3>
                ...
                <div class="box-tools pull-right">
                    ...
                    if ($sesi <= 3) {
                        //echo button('load_silent("wrh/kaca/formAdd","#content")', 'Input Stock', 'btn btn-success');
                    } else {
                        # code...
                    }
                    ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <?= button('load_silent("wrh/kaca/mutasi_stock_add/' . $row->id . '","#content")', 'mutasi', 'btn btn-xs btn-primary', 'data-toggle="tooltip" title="Mutasi"'); ?>
                                        <?= button('load_silent("wrh/kaca/mutasi_stock_history/' . $row->id . '","#content")', 'history mutasi', 'btn btn-xs btn-default', 'data-toggle="tooltip" title="History Mutasi"'); ?></td>
                                </tr>
...
<script type="text/javascript">
    ...
    function setFilter() {
        ...
        var jne = $('#jne').val();
        load_silent("wrh/kaca/filter/" + id_store + "/" + id_bulan + "/" + id_tahun + "/" + status + "/" + jne + "/", "#content");
