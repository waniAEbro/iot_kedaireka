<div class="box box-default">
    <div class="box-header with-border">
        <h3 class="box-title">Mutasi kaca</h3>
...
<script language="javascript">
    function mutasi() {
        ...
        if (qty1 >= qty2) {
            ...
            if ($('#id_gudang').val() != '' && $('#keranjang').val() != '' && $('#id_gudang2').val() != '' && $('#qty').val() != '' && $('#keranjang2').val() != '' && $('#qty2').val() != '') {
                $.ajax({
                    url: "<?= site_url('wrh/kaca/simpanMutasi') ?>",
                    dataType: "json",
                    type: "POST",
                    data: {
                    ...
                    success: function(data) {
                        ...
                        // load_silent("wrh/kaca/mutasi_stock_history/" + $('#item').val(), "#content");
                        load_silent("wrh/kaca", "#content");
                    }
                });
            }
    ...
    $("select[name=id_gudang2]").change(function() {
        $.ajax({
            url: "<?= site_url('wrh/kaca/inOptionGetKeranjang') ?>",
            dataType: "json",
            type: "POST",
            data: {
                "item": $('#item').val(),
