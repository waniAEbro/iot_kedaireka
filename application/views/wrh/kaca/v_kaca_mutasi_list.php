        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    ...
                    if ($sesi <= 3) {
                        echo button('load_silent("wrh/kaca/mutasi_add/","#content")', 'Tambah Mutasi', 'btn btn-primary', 'data-toggle="tooltip" title="Tambah Mutasi"');
                    } else {
                        # code...
                    }
                    ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if (from_session('level') == 1) { ?>
                                        <?= button_confirm("Apakah anda yakin menghapus Stock ini?", "wrh/kaca/deleteIn/" . $row->id, "#content", "Hapus", "btn btn-xs btn-danger", "") ?>
                                    <?php } ?>
                                </td>
...
<script type="text/javascript">
    ...
    function setAplikator(argument) {
        ...
        load_silent("wrh/kaca/mutasi_list/" + tlg1 + "/" + tgl2, "#content");
