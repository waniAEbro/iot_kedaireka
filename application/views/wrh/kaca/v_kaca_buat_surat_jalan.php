<div class="box box-default">
    <div class="box-header with-border">
        <h3 class="box-title">Stock OUT BON Surat Jalan kaca</h3>
...
<script language="javascript">
    function finish() {
        $("#finish").hide();
        $.ajax({
            url: "<?= site_url('wrh/kaca/simpanSuratJalan/') ?>",
            dataType: "json",
            type: "POST",
            data: {
                "id_fppp": $("#id_fppp").val(),
            ...
            success: function(img) {
                ...
                load_silent("wrh/kaca/list_surat_jalan/", "#content");
            }
        });
    ...
    $("#no_fppp").change(function() {
        $.ajax({
            url: "<?= site_url('wrh/kaca/getDetailFppp/') ?>",
            dataType: "json",
            type: "POST",
            data: {
                "no_fppp": $(this).val(),
