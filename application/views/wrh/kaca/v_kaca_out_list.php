    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Surat Jalan BOM kaca</h3>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center"><?= $row->tgl_upload_bom_kaca ?></td>
                                <td><?= $row->no_fppp ?></td>
                                ...
                                <td>
                                    <?php echo button('load_silent("wrh/kaca/stok_out_make/' . $row->id . '","#content")', 'Stock OUT', 'btn btn-xs btn-primary', 'data-toggle="tooltip" title="Stock OUT"'); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
