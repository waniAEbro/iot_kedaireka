...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var table = $('#memListTable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo base_url('wrh/aksesoris/getLists/'); ?>",
                "type": "POST"
            },
        ...
        $('#memListTable tbody').on('click', 'button.mutasi', function() {
            ...
            load_silent("wrh/aksesoris/mutasi_stock_add/" + data[0] + "", "#content");
        });
        $('#memListTable tbody').on('click', 'button.history_mutasi', function() {
            var data = table.row($(this).parents('tr')).data();
            load_silent("wrh/aksesoris/mutasi_stock_history/" + data[0] + "", "#modal");
        });
