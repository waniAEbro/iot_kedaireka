    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">BON Manual Aksesoris</h3>
    ...
    $(document).ready(function() {
        ...
        function format(id, row, tr) {
            ...
            infoTable = '<table id="infoTable" class="table table-striped" border="1px" style="font-size: smaller;">' +
                ...
                '<th bgcolor="#bfbfbf">Deskripsi</th>' +
            ...
            $.ajax({
                    url: "<?= site_url('wrh/aksesoris/getBonDetailTabel') ?>",
                    type: 'POST',
                    dataType: 'JSON',
                    data: {
                        id_bon: id_bon,
                ...
                .done(function(data) {
                    for (var i = 0; i < data.detail.length; i++) {
                        ...
                        infoTable += '<tr bgcolor="' + color + '">' +
                            ...
                            '<td><font color="' + fontcolor + '">' + data.detail[i].item_code + '</font></td>' +
                            '<td><font color="' + fontcolor + '">' + data.detail[i].deskripsi + '</font></td>' +
