...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
                ...
                <table width="100%" id="tableku" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        foreach ($list_bom_sj->result() as $row) :
                            ...
                            $qtyin           = $this->m_aksesoris->getQtyInDetailTabel($row->id_item, $row->id_divisi, $row->id_gudang, $row->keranjang);
                            $qtyout          = $this->m_aksesoris->getQtyOutDetailTabel($row->id_item, $row->id_divisi, $row->id_gudang, $row->keranjang);
                        ...
                        ?>
                                <tr>
                                    ...
                                    <?php if (from_session('level') < 3) { ?>
                                        <td align="center"><?php echo button_confirm("Anda yakin mengunci item " . $row->item_code . "?", "wrh/aksesoris/kuncidetailbom/" . $id_sj . "/" . $row->id_stock, "#content", 'Kunci', 'btn btn-xs btn-primary', 'data-toggle="tooltip" title="Kunci"'); ?></td>
                                    <?php } else { ?>
                                        <td align="center"></td>
                                    <?php } ?>
                                </tr>
                            <?php
                                ...
                                <tr>
                                    ...
                                    <?php if (from_session('level') < 3) { ?>
                                        <td align="center">Terkunci <?php echo button_confirm("Anda yakin mengunci item " . $row->item_code . "?", "wrh/aksesoris/bukakuncidetailbom/" . $id_sj . "/" . $row->id_stock, "#content", 'Buka Kunci', 'btn btn-xs btn-primary', 'data-toggle="tooltip" title="Buka Kunci"'); ?></td>
                                    <?php } else { ?>
                                        <td align="center"></td>
                                    <?php } ?>
                                </tr>
            ...
            <?php echo button_confirm("Anda yakin menambahkan item stock out?", "wrh/aksesoris/additemdetailbom/" . $id_sj . "/" . $id_fppp, "#modal", 'Add Item', 'btn btn-info', 'data-toggle="tooltip" title="Add Item"'); ?>
            <?php echo button_confirm("Anda yakin menyelesaikan stock out?", "wrh/aksesoris/finishdetailbom/" . $id_sj, "#content", 'Finish', 'btn btn-success', 'data-toggle="tooltip" title="Finish"'); ?>
        </div>
    </div>
</div>
