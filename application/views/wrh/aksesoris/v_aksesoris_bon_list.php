        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <?php
                    echo button('load_silent("wrh/aksesoris/bon_manual_add/","#content")', 'Add BON Manual', 'btn btn-primary', 'data-toggle="tooltip" title="BON Manual"');
                    ?>
                </div>
            </div>
            <div class="box-body">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    echo button('load_silent("wrh/aksesoris/lihat_item_stok_out/' . $row->id . '","#modal")', 'Lihat Item', 'btn btn-xs btn-primary', 'data-toggle="tooltip" title="Lihat Item Stock OUT"');
                                    echo button_confirm("Apakah anda yakin menghapus SJ BON " . $row->no_surat_jalan . "?", "wrh/aksesoris/deleteSJBon/" . $row->id, "#content", "Hapus", "btn btn-xs btn-danger", "");
                                    ?>
