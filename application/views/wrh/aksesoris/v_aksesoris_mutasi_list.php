    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Mutasi aksesoris</h3>
                <div class="box-tools pull-right">
                    <?php
                    $sesi = from_session('level');
                    if ($sesi <= 3) {
                        echo button('load_silent("wrh/aksesoris/mutasi_add/","#content")', 'Tambah Mutasi', 'btn btn-primary', 'data-toggle="tooltip" title="Tambah Mutasi"');
                    } else {
                        # code...
                    }
                    ?>
...
<script type="text/javascript">
    ...
    function setAplikator(argument) {
        ...
        load_silent("wrh/aksesoris/mutasi_list/" + tlg1 + "/" + tgl2, "#content");
