...
<script language="javascript">
    ...
    $("#id_fppp").change(function() {
        $.ajax({
            url: "<?= site_url('wrh/aluminium/getNamaProyek') ?>",
            dataType: "json",
            type: "POST",
            data: {
                'id_fppp': $("#id_fppp").val(),
    ...
    $("#id_gudang").change(function() {
        $.ajax({
            url: "<?= site_url('wrh/aluminium/getQtyDivisiGudang') ?>",
            dataType: "json",
            type: "POST",
            data: {
    ...
    $("select[name=id_fppp]").change(function() {
        ...
        if ($(this).val() == "") {
            ...
            $.ajax({
                url: "<?= site_url('wrh/aluminium/optionGetNamaProyek') ?>",
                dataType: "json",
                type: "POST",
                data: {
                    "fppp": $(this).val()
    ...
    $("select[name=nama_proyek]").change(function() {
        ...
        if ($(this).val() == "") {
            ...
            z = "<option>-- Select --</option>";
            $.ajax({
                url: "<?= site_url('wrh/aluminium/optionGetNoFppp') ?>",
                dataType: "json",
                type: "POST",
                data: {
