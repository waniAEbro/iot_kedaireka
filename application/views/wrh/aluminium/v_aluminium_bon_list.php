                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    echo button('load_silent("wrh/aluminium/lihat_item_stok_out/' . $row->id . '","#modal")', 'Lihat Item', 'btn btn-xs btn-primary', 'data-toggle="tooltip" title="Lihat Item Stock OUT"');
