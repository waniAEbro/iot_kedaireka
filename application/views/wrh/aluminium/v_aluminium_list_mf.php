        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    ...
                    <?= button('load_silent("wrh/aluminium/monitoring_mf_lama","#content")', 'Monitoring Lama', 'btn btn-danger', 'data-toggle="tooltip" title="Monitoring"'); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var table = $('#memListTable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo base_url('wrh/aluminium/getLists_mf/'); ?>",
                "type": "POST"
            },
