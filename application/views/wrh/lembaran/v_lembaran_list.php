    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Monitoring lembaran</h3>
                ...
                <div class="box-tools pull-right">
                    ...
                    if ($sesi <= 3) {
                        //echo button('load_silent("wrh/lembaran/formAdd","#content")', 'Input Stock', 'btn btn-success');
                    } else {
                        # code...
                    }
                    ?>
...
<script type="text/javascript">
    ...
    function setFilter() {
        ...
        var jne = $('#jne').val();
        load_silent("wrh/lembaran/filter/" + id_store + "/" + id_bulan + "/" + id_tahun + "/" + status + "/" + jne + "/", "#content");
