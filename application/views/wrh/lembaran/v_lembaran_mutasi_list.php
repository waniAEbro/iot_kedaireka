            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    ...
                    $sesi = from_session('level');
                        echo button('load_silent("wrh/lembaran/mutasi_add/","#content")', 'Tambah Mutasi', 'btn btn-primary', 'data-toggle="tooltip" title="Tambah Mutasi"');
...
<script type="text/javascript">
    ...
    function setAplikator(argument) {
        ...
        load_silent("wrh/lembaran/mutasi_list/" + tlg1 + "/" + tgl2, "#content");
