    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Rekap In pvc</h3>
            </div>
            <div class="box-body">
                <?php
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $sts ?></td>
                                        <td><?php echo button('load_silent("inout/pvc/formedit/' . $row->id_ds . '","#modal")', 'Edit', 'btn btn-info btn-xs', 'data-toggle="tooltip" title="Edit"');?></td>
...
<script language="javascript">
    ...
    function setAplikator(argument) {
        ...
        load_silent("inout/pvc/diSet/" + tlg1 + "/" + tgl2, "#content");
    ...
    function cetakExcel() {
        ...
        var url = "<?= site_url('inout/pvc/diSetCetak/"+tlg1+"/"+tgl2+"') ?>";
