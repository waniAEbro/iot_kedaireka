        ...
        <form method="post" class="form-vertical form_faktur" role="form">
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>No Memo</label>
                <input type="text" class="form-control" id="nomor_memo" name="nomor_memo" value="<?=$nomor_memo?>" placeholder="No Memo" readonly required>
              </div>              
            </div>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_project" name="nama_project" placeholder="Nama Project" required autocomplete="off">
              </div>              
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label>Alamat Project</label>
                <input type="text" class="form-control" id="alamat_project" name="alamat_project" placeholder="Alamat Project" required autocomplete="off">
              </div>              
            </div>
          </div>
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" data-date-format="yyyy-mm-dd" value="<?=date('Y-m-d')?>" class="form-control datepicker" id="tgl_memo" placeholder="Tanggal Memo" required>
              </div>             
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label>Deadline Pengambilan</label>
                <input type="text" data-date-format="yyyy-mm-dd" value="<?=date('Y-m-d')?>" class="form-control datepicker" id="deadline_pengambilan" placeholder="Deadline Pengambilan" required>
              </div>             
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label>No FPPP</label>
                <input type="text" class="form-control" id="no_fppp" name="no_fppp" placeholder="No FPPP" required autocomplete="off">
              </div>             
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="form-group">
                <label>Alasan</label>
                <input type="text" class="form-control" id="alasan" name="alasan" placeholder="Alasan Memo" required autocomplete="off">
              </div>             
            </div>
          </div>
            ...
            <form method="post" class="form-vertical form" role="form" id="formid">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" id="id_memo" name="id_memo" readonly>
...
function save()
{
  $(this).find("button[type='submit']").prop('disabled',true);
    ...
    if(path == ''){
        ...
        $.ajaxFileUpload
          ({
            url:site+'klg/memo/savememoImage',
            secureuri:false,
