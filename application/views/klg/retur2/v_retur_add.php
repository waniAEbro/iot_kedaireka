                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?=$no_retur?>" id="no_retur" name="no_retur" autocomplete="off" readonly>
                    </div>              
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                 ...
                 <div class="row tglkirim">
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" data-date-format="yyyy-mm-dd" value="<?=date('Y-m-d')?>" class="form-control datepicker" id="tgl_kirim" placeholder="Tanggal Pengiriman" required>
                    </div>              
                  </div>
                </div>
                <div class="row">
