...
<table cellpadding="0">
  <tr>
    <td colspan="3" align="center"><h1>PIVOT TABLE OTS</h1></td>
  </tr>
</table>
<br>
<br>';
...
$html .= '<th colspan="3" width="10%" align="center">'.$wa->warna.'</th>';
          $j++;
          }
$html .= '</tr>
        <tr bgcolor="#b0ceff">';
...
$html .= '<tr>
        ...
        foreach ($warna->result() as $war) { 
          $PR = $this->m_monitoring->getrowJumR($val->id,$war->id);
          $PL = $this->m_monitoring->getrowJumL($val->id,$war->id);
          $PN = $this->m_monitoring->getrowJumN($val->id,$war->id);
          
$html .= '<td align="center">'.$PL.'</td>
