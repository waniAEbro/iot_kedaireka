      ...
      <div class="col-lg-12">
        <div class="box box-primary">
          <div class="box-header with-border">
              <?php
                echo button('load_silent("klg/monitoring/common/","#content")','Common','btn btn-primary','data-toggle="tooltip"');
                echo button('load_silent("klg/monitoring/custom/","#content")','Custom','btn btn-default','data-toggle="tooltip"');
              ?>

            <div class="box-tools pull-right">
              <h3 class="box-title">Monitoring OTS Common</h3>
            </div>
          </div>
          <div class="box-body">
            <div class="row">
                ...
                <div class="form-group">
                  ...
                  <select id="tgl" name="tgl" class="form-control select2" required>
                    ...
                    <?php foreach ($tgl->result() as $valap):?>
                      <?php if($tglkirim==$valap->tgl_pengiriman){$selected='selected';}else{$selected='';}?>
                ...
                <div class="form-group">
                  ...
                  <select id="store" name="store" class="form-control select2" required>
                    ...
                    <?php foreach ($store->result() as $valap):?>
                      <?php if($storemitra==$valap->id_store){$selected='selected';}else{$selected='';}?>
          ...
          <?php 
          $i = 1;
          $total_permintaan=0;$total_unsent=0;$total_sent=0;
...
<script type="text/javascript">
  ...
  var tgl   = $('#tgl').val();
  if (tgl != '') { var dari = tgl; } else{ var dari = 'x'; };

  var store   = $('#store').val();
  if (store != '') { var toko = store; } else{ var toko = 'x'; };

  load_silent("klg/monitoring/commonfilter/"+dari+"/"+toko+"/","#content");
