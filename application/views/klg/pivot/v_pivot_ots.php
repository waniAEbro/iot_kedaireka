...
<table cellpadding="0">
  <tr>
    <td colspan="2" align="center"><h1>PIVOT TABLE OTS PENGIRIMAN</h1></td>
...
$html .= '<th colspan="'.$colspan.'" width="6%" align="center">'.$wa->warna.'</th>';
          $j++;
          }
$html .= '</tr>
        <tr bgcolor="#f266ff">';
...
$st = $this->m_summary->getrowJumOTS($val->id,$war->id,$bua->bukaan);
        if ($st > 0) {
           $st_tampil = $st;
         } else {
            $st_tampil = '-';
