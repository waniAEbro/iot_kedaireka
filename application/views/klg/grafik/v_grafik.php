  ...
  <div class="col-lg-12">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">Grafik Status Quotation</h3>
      </div>
      <div class="box-body">
      <?php 
              ...
              <div class="form-group">
                ...
                <select id="aplikator" name="aplikator" class="form-control select2" required>
                  ...
                  <?php foreach ($aplikator->result() as $valap):?>
                    <?php if($kode==$valap->kode){$selected='selected';}else{$selected='';}?>
                    <option value="<?=$valap->kode?>" <?=$selected?> >[<?=$valap->kode?>] - <?=$valap->aplikator?></option>
                  <?php endforeach;?>
                </select>
              </div>              
            </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="box-tools pull-right">
              <a class="btn btn-success" onclick="setAplikator()">Pilih Aplikator</a>
            </div>
           </div>
        </div>
        <?php } ?>
      ...
      <div class="box-body">
        ...
        <table id="datatable" style="display:none;">
          <thead>
            <tr>
              <th></th>
              <th>Grafik Rekap Status Quotation</th>
...
function setAplikator (argument) {
  ...
  load_silent("klg/grafik/diSet/"+kode+"/"+dari+"/"+sampai+"/","#content");
