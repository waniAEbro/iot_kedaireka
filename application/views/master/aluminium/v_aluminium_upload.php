        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <ul>
                    ...
                    <li>Download format upload untuk <b>Master aluminium</b> <?php echo '<a class="btn btn-xs btn-primary" target="_blank" href="' . base_url('files/master_aluminium.xlsx') . '" >Download</a>'; ?></li>
                </ul>
            </div>
            <div class="box-body">
...
<script type="text/javascript">
    ...
    function save() {
        ...
        $('#loading').show(100);
        $.ajaxFileUpload({
            url: site + 'master/aluminium/saveimport',
            secureuri: false,
            fileElementId: 'file',
            dataType: 'json',
            data: {
            ...
            success: function(data) {
                ...
                load_silent("master/aluminium/", "#content");
            },
