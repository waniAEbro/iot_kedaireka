        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <ul>
                    ...
                    <li>Download format upload untuk <b>Master Barang</b> <?php echo '<a class="btn btn-xs btn-primary" target="_blank" href="' . base_url('files/master_barang.xlsx') . '" >Download</a>'; ?></li>
                </ul>
            </div>
            <div class="box-body">
...
<script type="text/javascript">
    ...
    function save() {
        ...
        $('#loading').show(100);
        $.ajaxFileUpload({
            url: site + 'master/barang/saveimport',
            secureuri: false,
            fileElementId: 'file',
            dataType: 'json',
            data: {
