<div class="box box-default">
  <div class="box-header with-border">
    <h3 class="box-title">Form Invoice Pelanggan</h3>
    ...
    <form method="post" class="form-vertical form_faktur" role="form">
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="no_invoice" name="no_invoice" value="<?= $nomor_invoice ?>" placeholder="No Invoice" readonly required>
          </div>
        </div>
      </div>
          ...
          <div class="form-group">
            ...
            <select id="jenis_market" name="jenis_market" class="form-control">
              ...
              <?php foreach ($jenis_market->result() as $valap) : ?>
                <?php if ($sesi_jenis_market == $valap->id) {
                  $selected = 'selected';
                } else {
                  $selected = '';
                } ?>
      ...
      <div class="row">
          ...
          <div class="form-group">
            ...
            <select id="kategori_lokasi" name="kategori_lokasi" class="form-control">
              ...
              <?php foreach ($kategori_lokasi->result() as $valap) : ?>
                <option value="<?= $valap->id ?>"><?= $valap->kategori_lokasi ?></option>
              <?php endforeach; ?>
            </select>
          </div>
        </div>
          ...
          <div class="form-group">
            ...
            <select id="case" name="case" class="form-control">
              ...
              <?php foreach ($case as $valap) : ?>
                <option value="<?= $valap->id ?>"><?= $valap->case ?></option>
              <?php endforeach; ?>
            </select>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
            <label>Pembeli</label>
            <input type="text" class="form-control" id="pembeli" name="pembeli" placeholder="Pembeli" required>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="text" data-date-format="yyyy-mm-dd" class="form-control datepicker" id="tgl_pengiriman" placeholder="Tanggal Pengiriman" required>
          </div>
        </div>
      </div>
      <div class="row">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="text" class="form-control" id="diskon" placeholder="Diskon (Margin)">
        ...
        <div class="col-md-4">
          <div class="form-group">
            <label>PPN</label>
            <div class="input-group">
              <input type="text" class="form-control" id="ppn" value="10" placeholder="PPN">
              <span class="input-group-addon"><b>%</b></span>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="biaya_kirim" placeholder="Biaya Pengirirman">
          </div>
        </div>
      </div>
...
<script language="javascript">
  ...
  function save() {
    ...
    $.ajax({
      type: "POST",
      url: site + 'warehouse/invoice/saveInvoice',
      dataType: 'json',
      data: {
