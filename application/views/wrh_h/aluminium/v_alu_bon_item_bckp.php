...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
            ...
            <?php echo button_confirm("Anda yakin menyelesaikan stock out BON?", "wrh_h/aluminium/buat_surat_jalan_bon/", "#content", 'Finish Buat Surat Jalan', 'btn btn-success', 'data-toggle="tooltip" title="Finish Buat Surat Jalan"'); ?>
        </div>
    </div>
</div>
<script type="text/javascript">
    ...
    $("select[name=id_divisi]").change(function() {
        ...
        if ($(this).val() == "") {
            ...
            $.ajax({
                url: "<?= site_url('wrh_h/aluminium/optionGetGudangDivisi') ?>",
                dataType: "json",
                type: "POST",
                data: {
                    "item": $('#item').val(),
