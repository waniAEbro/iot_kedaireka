    ...
    <div class="col-lg-3">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Input Mutasi Aluminium</h3>
            </div>
...
<script language="javascript">
    function finish() {
        if (confirm('Anda yakin ingin menyelesaikan?')) {
            ...
            load_silent("wrh_h/aluminium/mutasi_list", "#content");
        }
    }
    ...
    function quotation() {
        ...
        if (qty1 >= qty2) {
            ...
            if ($('#id_gudang').val() != '' && $('#keranjang').val() != '' && $('#id_gudang2').val() != '' && $('#qty').val() != '' && $('#keranjang2').val() != '' && $('#qty2').val() != '') {
                $.ajax({
                    url: "<?= site_url('wrh_h/aluminium/simpanMutasi') ?>",
                    dataType: "json",
                    type: "POST",
                    data: {
    ...
    function hapus(i) {
        if (confirm('Lanjutkan Proses Hapus?')) {
            $.ajax({
                    type: "POST",
                    url: "<?= site_url('wrh_h/aluminium/deleteMutasiIn') ?>",
                    dataType: 'json',
                    data: {
                        'id': i
                    }
