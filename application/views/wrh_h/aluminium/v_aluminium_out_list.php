    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Surat Jalan BOM Aluminium HRB</h3>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php
                                    echo button('load_silent("wrh_h/aluminium/stok_out_make/' . $row->id . '","#content")', 'Stock OUT', 'btn btn-xs btn-primary', 'data-toggle="tooltip" title="Stock OUT"');
                                    echo button_confirm("Apakah anda yakin mengubah status menjadi lunas pada no FPPP: " . $row->no_fppp . "?", "wrh_h/aluminium/make_lunas/" . $row->id, "#content", "Lunas", "btn btn-xs btn-success", "");
                                    ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
