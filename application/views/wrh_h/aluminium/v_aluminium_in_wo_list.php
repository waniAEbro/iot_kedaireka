    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Stok IN WO HRB</h3>
                <div class="box-tools pull-right">
                    <?php
                    $sesi = from_session('level');
                    if ($sesi <= 3) {
                        echo button('load_silent("wrh_h/aluminium/stok_in_wo_add/","#content")', 'Tambah Stock', 'btn btn-primary', 'data-toggle="tooltip" title="Tambah Stock"');
                    } else {
                        # code...
                    }
                    ?>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($bln == $now) { ?>
                                        <?= button_confirm("Apakah anda yakin menghapus Stock ini?", "wrh_h/aluminium/deleteIn_wo/" . $row->id, "#content", "Hapus", "btn btn-xs btn-danger", "") ?>
                                    <?php } ?>
                                </td>
...
<script type="text/javascript">
    ...
    function setAplikator(argument) {
        ...
        load_silent("wrh_h/aluminium/stok_in_wo_set/" + tlg1 + "/" + tgl2, "#content");
