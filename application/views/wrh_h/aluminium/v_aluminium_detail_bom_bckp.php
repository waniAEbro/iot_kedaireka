...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?= $row->section_ata ?>
                                        <br><?php //echo button_confirm("Anda yakin mengirim parsial item " . $row->section_ata . "?", "wrh_h/aluminium/kirimparsial/" . $id_fppp . "/" . $row->id_stock, "#content", 'Kirim Parsial', 'btn btn-xs btn-default', 'data-toggle="tooltip" title="Kirim Parsial"'); 
                                            ?>
                                    </td>
                                    ...
                                    <?php if (from_session('level') < 3) { ?>
                                        <td align="center"><?php echo button_confirm("Anda yakin mengunci item " . $row->section_ata . "?", "wrh_h/aluminium/kuncidetailbom/" . $id_sj . "/" . $row->id_stock, "#content", 'Kunci', 'btn btn-xs btn-primary', 'data-toggle="tooltip" title="Kunci"'); ?></td>
                                    <?php } else { ?>
                                        <td align="center"></td>
                                    <?php } ?>
                                </tr>
                            <?php
                                ...
                                <tr>
                                    ...
                                    <?php if (from_session('level') < 3) { ?>
                                        <td align="center">Terkunci <?php echo button_confirm("Anda yakin mengunci item " . $row->section_ata . "?", "wrh_h/aluminium/bukakuncidetailbom/" . $id_sj . "/" . $row->id_stock, "#content", 'Buka Kunci', 'btn btn-xs btn-primary', 'data-toggle="tooltip" title="Buka Kunci"'); ?></td>
                                    <?php } else { ?>
                                        <td align="center"></td>
                                    <?php } ?>
                                </tr>
            ...
            <?php echo button_confirm("Anda yakin menambahkan item stock out?", "wrh_h/aluminium/additemdetailbom/" . $id_sj . "/" . $id_fppp, "#modal", 'Add Item', 'btn btn-info', 'data-toggle="tooltip" title="Add Item"'); ?>
            <?php echo button_confirm("Anda yakin menyelesaikan stock out?", "wrh_h/aluminium/finishdetailbom/" . $id_sj, "#content", 'Finish', 'btn btn-success', 'data-toggle="tooltip" title="Finish"'); ?>
        </div>
    </div>
</div>
