        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    ...
                    if ($sesi <= 3) {
                        echo button('load_silent("wrh_h/aluminium/mutasi_add/","#content")', 'Tambah Mutasi', 'btn btn-primary', 'data-toggle="tooltip" title="Tambah Mutasi"');
                    } else {
                        # code...
                    }
                    ?>
...
<script type="text/javascript">
    ...
    function setAplikator(argument) {
        ...
        load_silent("wrh_h/aluminium/mutasi_list/" + tlg1 + "/" + tgl2, "#content");
