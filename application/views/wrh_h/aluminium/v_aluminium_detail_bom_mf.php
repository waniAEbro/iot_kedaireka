                    ...
                    <tbody>
                        ...
                        ?>
                                <tr bgcolor="<?= $bgrow ?>">
                                    ...
                                    <td><?= $row->brand ?></td>
                                    <td><?= $row->section_ata ?>
                                        <br><?php echo button_confirm("Anda yakin mengirim parsial item " . $row->section_ata . "-" . $row->section_allure . "?", "wrh_h/aluminium/kirim_parsial_mf/" . $id_fppp . "/" . $row->id_stock, "#content", 'Kirim Parsial', 'btn btn-xs btn-default', 'data-toggle="tooltip" title="Kirim Parsial"'); ?>
            ...
            if (parseInt(qty_gudang) < parseInt(value)) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // if (value == 0) {
                        load_silent("wrh_h/aluminium/stok_out_make_mf/" + id_fppp, "#content");
                        // }
                        // console.log(qtybom);
                        // console.log(value);
                        // gudang(edit_id);
