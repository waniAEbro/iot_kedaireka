...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div style="text-align:center">
      <img src="<?php echo base_url('assets/img/logo.png') ?>" width="250px" style="padding:10px;">
    </div>
    <div class="login-box-body">
      ...
      <div class="form-group has-feedback">
        <input type="text" name="captcha" placeholder="Security Code" class="form-control" id="exampleInputEmail1" autocomplete="off">
