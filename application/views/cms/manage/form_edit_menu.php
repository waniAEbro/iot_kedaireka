        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label">
             Aktif</label>
            <div class="col-sm-9">
            <select id="aktif" name="aktif" class="form-control" style="width:100%" required>
          ...
          <div class="form-group">
            <label class="col-sm-3 control-label">
                Grup Menu</label>
            <div class="col-sm-9">
            <select id="grup" name="grup" class="form-control" style="width:100%" required>
                <?php foreach ($grup->result() as $val): 
                if($val->id_grup_menu==$row->grup){$sel="selected";}else{$sel="";}?>
                  <option value="<?=$val->id_grup_menu?>" <?=$sel?>><?=$val->nama_grup?></option>
                <?php endforeach;?>
              </select>
