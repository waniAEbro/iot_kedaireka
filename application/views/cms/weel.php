...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>assets/plugins/datatables/extensions/FixedColumns/css/dataTables.fixedColumns.min.css">
  </script>
  <link rel="stylesheet" href="<?= base_url(); ?>assets/plugins/datatables/extensions/TableTools/css/dataTables.tableTools.min.css">
  </script>
  <!-- Theme style -->
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-lg">
            <font color="#bfbfbf"><?php echo $this->config->item('title') ?></font>
          </span>
        </a>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p>
                <font color="#bfbfbf" size="2px">Login As :</font>
              </p>
